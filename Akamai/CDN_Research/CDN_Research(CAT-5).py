...
def open_excels():
    ...
    sheet_load = source.get_sheet_by_name("CAT-5")
    destination = xlsxwriter.Workbook("CDN_Research(CAT-41).xlsx")
...
def get_domain(loadsheet, savesheet):
    ...
    for rownum in range(982, 1000):  # 복사붙여넣기 용 : loadsheet.max_row+1
        try:
            # 2-1-1. 로그
...
def find_Vendor(cDomain):
    category = {
        "Akamai": [".globalredir.akadns.net", ".akadns.net", ".edgekey.net", ".edgesuite.net", ".akamaiedge.net",
                   ".akamai.net"],
        ...
        "Cdnetworks": [".gccdn.net", ".cdnetworks.net", ".cdngc.net", ".cdngs.net", ".speedcdn.net", ".cdngl.net",
                       ".cdnga.net"],
